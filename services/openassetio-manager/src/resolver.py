"""OpenAssetIO resolver that queries the SpaceHarbor control-plane API.

In production, resolves entity references via HTTP calls to the control-plane.
In dev mode (SPACEHARBOR_CONTROL_PLANE_URL not set), falls back to in-memory store.
"""
...
class VastResolver:
    ...
    def __post_init__(self):
        self._control_plane_url = os.environ.get("SPACEHARBOR_CONTROL_PLANE_URL", "")
