...
COPIED FROM: services/dataengine-functions/exr-inspector/src/inspector.py
NOTE: This is a duplicated module for container deployment isolation.
      Changes should be synchronized back to the canonical source.
      Differences: This copy omits provenance extraction (Phase C feature).
