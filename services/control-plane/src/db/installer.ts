...
function printUsage(): void {
  console.log(`
AssetHarbor Database Installer
...
Optional:
  ...
  --schema <name>          Schema name (default: "assetharbor/production")
  --help                   Show this help
`.trim());
}
...
async function main(): Promise<void> {
  ...
  if (!args.trinoEndpoint) missing.push("--trino-endpoint");
  if (!args.accessKey) missing.push("--access-key");
  if (!args.secretKey) missing.push("--secret-key");
