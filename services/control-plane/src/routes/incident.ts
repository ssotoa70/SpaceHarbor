...
export async function registerIncidentRoute(
  ...
  for (const prefix of prefixes) {
    ...
    }, async () => await persistence.getIncidentCoordination());
    ...
    app.put<{
      ...
      async (request, reply) => {
        ...
        const current = (await persistence.getIncidentCoordination()).guidedActions.updatedAt;
        ...
        const guidedActions = await persistence.updateIncidentGuidedActions(
          {
    ...
    app.post<{
      ...
      async (request, reply) => {
        ...
        const note = await persistence.addIncidentNote(
          {
            message,
            correlationId,
            author
    ...
    app.put<{
      ...
      async (request, reply) => {
        ...
        const current = (await persistence.getIncidentCoordination()).handoff.updatedAt;
        if (expectedUpdatedAt !== current) {
        ...
        const handoff = await persistence.updateIncidentHandoff(
          {
